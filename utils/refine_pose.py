...
def refine_pose(model_path, sample, pred_r, pred_t, num_iters=50, lr=0.0005, verbose=False):
    ...
    return rf.refine_pose(R, T, gt_depth.cuda(), num_iters=num_iters, lr=lr, verbose=verbose)
